...
public class ScreenCapturer {
    ...
    public static ScreenCapturer getInstance(Context mContext, Intent data, int orientation, int density, Handler handler, ScriptRuntime mScriptRuntime) {
        if (INSTANCE_CACHE == null) {
            INSTANCE_CACHE = new ScreenCapturer(mContext, data, orientation, density, handler);
        }
