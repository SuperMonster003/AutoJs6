...
表格中 `活跃维护期` 列包含尖括号 (`<>`) 的数据, 其统计截止日期为 2025 年 9 月 24 日.
...
* [Rhino](https://github.com/mozilla/rhino/) 引擎由 [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) 升级至 [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (更新于 2025 年 9 月 10 日)
...
截至 2025 年 9 月 24 日, AutoJs6 可支持 JDK 最高版本为 `24`.
