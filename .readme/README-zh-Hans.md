...
表格中 `活跃维护期` 列包含尖括号 (`<>`) 的数据, 其统计截止日期为 2025 年 11 月 1 日.
...
下载 `Android Studio Otter | 2025.2.1` 版本 (按需选择其一):
...
> 注: 上述版本发布时间为 2025 年 10 月 30 日. 如需下载其他版本, 或上述链接已失效, 可访问 [Android Studio 发行版本归档](https://developer.android.com/studio/archive?hl=en) 页面.
...
截至 2025 年 11 月 1 日, AutoJs6 可支持 JDK 最高版本为 `24`.
