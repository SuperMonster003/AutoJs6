...
표에서 `활성 유지보수 기간` 열에 꺾쇠괄호 (`<>`) 가 포함된 데이터는 통계 기준일이 2025 년 9 월 24 일 임을 나타냅니다.
...
* [Rhino](https://github.com/mozilla/rhino/) 엔진을 [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) 에서 [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) 로 업그레이드 (2025 년 9 월 10 일 업데이트됨)
...
2025 년 9 월 24 일 기준으로, AutoJs6이 지원하는 최대 JDK 버전은 `24` 입니다.
