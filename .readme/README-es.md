...
En la tabla, los datos de la columna `Mantenimiento activo` que contienen paréntesis angulares (`<>`) se han calculado hasta 1 de November de 2025.
...
Descarga la versión `Android Studio Otter | 2025.2.1` (elige una según tus necesidades):
...
> Nota: La fecha de lanzamiento de la versión anterior es el 30 de October de 2025. Para descargar otras versiones, o si los enlaces anteriores ya no funcionan, puedes visitar la página del [Archivo de versiones de Android Studio](https://developer.android.com/studio/archive?hl=en).
...
Hasta el 1 de November de 2025, AutoJs6 soporta hasta la versión `24` de JDK.
