...
في الجدول، يتم احتساب البيانات في العمود `فترة الصيانة النشطة` التي تحتوي على أقواس زاوية (`<>`) حتى 10 September 2025.
...
اعتبارًا من 10 September 2025، الإصدار الأقصى المدعوم من JDK لمشروع AutoJs6 هو `24`.
