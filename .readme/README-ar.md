...
في الجدول، يتم احتساب البيانات في العمود `فترة الصيانة النشطة` التي تحتوي على أقواس زاوية (`<>`) حتى 1 November 2025.
...
قم بتنزيل إصدار `Android Studio Otter | 2025.2.1` (حدد أحدها حسب الحاجة):
...
> ملاحظة: تاريخ الإصدار بالنسخة المذكورة أعلاه هو 30 October 2025. إذا كنت بحاجة إلى تنزيل إصدار آخر، أو إذا كان الرابط المذكور غير صالح، يمكنك زيارة [أرشيف إصدارات Android Studio](https://developer.android.com/studio/archive?hl=en).
...
اعتبارًا من 1 November 2025، الإصدار الأقصى المدعوم من JDK لمشروع AutoJs6 هو `24`.
