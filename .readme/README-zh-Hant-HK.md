...
表格中 `活躍維護期` 列包含尖括號 (`<>`) 的數據, 其統計截止日期為 2025 年 11 月 1 日.
...
下載 `Android Studio Otter | 2025.2.1` 版本 (按需選擇其一):
...
> 注: 上述版本發佈時間為 2025 年 10 月 30 日. 如需下載其他版本, 或上述鏈接已失效, 可訪問 [Android Studio 發行版本歸檔](https://developer.android.com/studio/archive?hl=en) 頁面.
...
截至 2025 年 11 月 1 日, AutoJs6 可支持 JDK 最高版本為 `24`.
