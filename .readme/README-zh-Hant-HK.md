...
表格中 `活躍維護期` 列包含尖括號 (`<>`) 的數據, 其統計截止日期為 2025 年 9 月 24 日.
...
* [Rhino](https://github.com/mozilla/rhino/) 引擎由 [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) 升級至 [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (更新於 2025 年 9 月 10 日)
...
截至 2025 年 9 月 24 日, AutoJs6 可支持 JDK 最高版本為 `24`.
