...
表では, `アクティブメンテナンス期間` 列に山括弧 (`<>`) を含むデータは, 統計の締め日が 2025 年 10 月 26 日 であることを示します.
...
* [Rhino](https://github.com/mozilla/rhino/)エンジンが [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) から [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (2025 年 10 月 5 日 更新) にアップグレードされました
...
`Android Studio Narwhal 4 Feature Drop | 2025.1.4` バージョンをダウンロードしてください (いずれかを選択):
...
> 注: 上述バージョンのリリース日は 2025 年 10 月 9 日 です. その他のバージョンをダウンロードするか, 上記のリンクが失効している場合は, [Android Studioリリースアーカイブ](https://developer.android.com/studio/archive?hl=en)のページをご覧ください.
...
2025 年 10 月 26 日 現在, AutoJs6がサポートする最大のJDKバージョンは `24` です.
