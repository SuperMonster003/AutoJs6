...
Dans le tableau, les données de la colonne `Maintenance active` contenant des chevrons (`<>`) sont calculées jusqu’au 1 November 2025.
...
Téléchargez la version `Android Studio Otter | 2025.2.1` (choisissez-en une selon vos besoins):

- [android-studio-2025.2.1.7-windows.exe](https://redirector.gvt1.com/edgedl/android/studio/install/2025.2.1.7/android-studio-2025.2.1.7-windows.exe) (1.33 GiB)
- [android-studio-2025.2.1.7-windows.zip](https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2025.2.1.7/android-studio-2025.2.1.7-windows.zip) (1.35 GiB)
- [android-studio-2025.2.1.7-linux.tar.gz](https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2025.2.1.7/android-studio-2025.2.1.7-linux.tar.gz) (1.37 GiB)

> Note : La version mentionnée ci-dessus a été publiée le 30 October 2025. Pour télécharger d'autres versions ou si le lien ci-dessus n'est plus valide, visitez la page [archive des versions de Android Studio](https://developer.android.com/studio/archive?hl=en).
...
À partir du 1 November 2025, AutoJs6 prend en charge la version maximale de JDK `24`.
