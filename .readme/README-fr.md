...
Dans le tableau, les données de la colonne `Maintenance active` contenant des chevrons (`<>`) sont calculées jusqu’au 27 October 2025.
...
* Le moteur [Rhino](https://github.com/mozilla/rhino/) a été mis à niveau de [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) à [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (mis à jour le 5 October 2025)
...
* `Amélioration` Certaines dépendances ou versions de bibliothèques locales ont été ajustées _[`CHANGELOG.md`](http://project.autojs6.com/blob/master/app/src/main/assets-app/doc/CHANGELOG.md#v663)_
...
Téléchargez la version `Android Studio Narwhal 4 Feature Drop | 2025.1.4` (choisissez-en une selon vos besoins):

- [android-studio-2025.1.4.8-windows.exe](https://redirector.gvt1.com/edgedl/android/studio/install/2025.1.4.8/android-studio-2025.1.4.8-windows.exe) (1.30 GiB)
- [android-studio-2025.1.4.8-windows.zip](https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2025.1.4.8/android-studio-2025.1.4.8-windows.zip) (1.31 GiB)
- [android-studio-2025.1.4.8-linux.tar.gz](https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2025.1.4.8/android-studio-2025.1.4.8-linux.tar.gz) (1.34 GiB)

> Note : La version mentionnée ci-dessus a été publiée le 9 October 2025. Pour télécharger d'autres versions ou si le lien ci-dessus n'est plus valide, visitez la page [archive des versions de Android Studio](https://developer.android.com/studio/archive?hl=en).
...
Ouvrir la page de paramètres `Android SDK (Kit de développement logiciel Android)` (l'une des méthodes suivantes) :

```text
Help (Aide) | Find action (Rechercher une action) # Saisir "Android SDK"
[ ou ]
File (Fichier) | Settings (Paramètres) # Rechercher "Android SDK"
[ ou ]
File (Fichier) | Settings (Paramètres) | Language & Frameworks (Langages et Frameworks) | Android SDK (Kit de développement logiciel Android)
[ ou ]
File (Fichier) | Settings (Paramètres) | Appearance & Behavior (Apparence et Comportement) | Paramètres système (System Settings) | Android SDK (Kit de développement logiciel Android)
```
...
Ouvrir la page de paramètres `SDK Tools (Outils du SDK)` (l'une des méthodes suivantes) :

```text
Help (Aide) | Find action (Rechercher une action) # Saisir "SDK Tools"
[ ou ]
File (Fichier) | Settings (Paramètres) # Rechercher "SDK Tools"
[ ou ]
File (Fichier) | Settings (Paramètres) | Language & Frameworks (Langages et Frameworks) | Android SDK (Kit de développement logiciel Android) | Outils SDK (SDK Tools) (situés dans la fenêtre de droite)
[ ou ]
File (Fichier) | Settings (Paramètres) | Appearance & Behavior (Apparence et Comportement) | Paramètres système (System Settings) | Android SDK (Kit de développement logiciel Android) | Outils SDK (SDK Tools) (situés dans la fenêtre de droite) 
```
...
À partir du 27 October 2025, AutoJs6 prend en charge la version maximale de JDK `24`.
...
Ouvrir la page de paramètres `Gradle JDK` (l'une des méthodes suivantes) :

```text
Help (Aide) | Find action (Rechercher une action) # Saisir "Gradle JDK"
[ ou ]
File (Fichier) | Settings (Paramètres) # Rechercher "Gradle"
[ ou ]
File (Fichier) | Settings (Paramètres) | Build, Execution, Deployment (Compilation, Exécution, Déploiement) | Outils de construction (Build Tools) | Gradle
```
