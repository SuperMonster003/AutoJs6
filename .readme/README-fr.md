...
Dans le tableau, les données de la colonne `Maintenance active` contenant des chevrons (`<>`) sont calculées jusqu’au 24 September 2025.
...
À partir du 24 September 2025, AutoJs6 prend en charge la version maximale de JDK `24`.
