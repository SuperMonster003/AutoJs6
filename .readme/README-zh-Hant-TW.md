...
表格中 `活躍維護期` 列包含尖括號 (`<>`) 的資料, 其統計截止日期為 2025 年 10 月 26 日.
...
> 注: 上述版本釋出時間為 2025 年 10 月 9 日. 如需下載其他版本, 或上述連結已失效, 可訪問 [Android Studio 發行版本歸檔](https://developer.android.com/studio/archive?hl=en) 頁面.
...
截至 2025 年 10 月 26 日, AutoJs6 可支援 JDK 最高版本為 `24`.
