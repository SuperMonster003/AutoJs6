...
Скачайте версию `Android Studio Meerkat | 2024.3.1` (выберите одну из них по необходимости):
...
> Примечание: Указанная версия была выпущена 4 March 2025 г.. Для загрузки других версий или если указанная ссылка недействительна, посетите страницу [архива версий Android Studio](https://developer.android.com/studio/archive?hl=en).
...
По состоянию на 19 March 2025 г. AutoJs6 поддерживает JDK максимальной версии `24`.
