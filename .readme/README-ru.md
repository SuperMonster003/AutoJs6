...
В таблице данные в столбце `Период активного обслуживания`, содержащие угловые скобки (`<>`), учитываются по состоянию на 1 November 2025 года.
...
Скачайте версию `Android Studio Otter | 2025.2.1` (выберите одну из них по необходимости):
...
> Примечание: Указанная версия была выпущена 30 October 2025 года. Для загрузки других версий или если указанная ссылка недействительна, посетите страницу [архива версий Android Studio](https://developer.android.com/studio/archive?hl=en).
...
По состоянию на 1 November 2025 года AutoJs6 поддерживает JDK максимальной версии `24`.
