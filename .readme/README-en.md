...
In the table, data in the `Active Maintenance` column that contains angle brackets (`<>`) is calculated up to Nov 1, 2025.
...
Download `Android Studio Otter | 2025.2.1` version (choose one as needed):
...
> Note: The release date for the above version is Oct 30, 2025. To download other versions, or if the above link is invalid, you can visit the [Android Studio release archive](https://developer.android.com/studio/archive?hl=en) page.
...
As of Nov 1, 2025, AutoJs6 supports up to version `24` of the JDK.
