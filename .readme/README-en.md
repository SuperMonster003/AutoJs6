...
In the table, data in the `Active Maintenance` column that contains angle brackets (`<>`) is calculated up to Sep 24, 2025.
...
As of Sep 24, 2025, AutoJs6 supports up to version `24` of the JDK.
