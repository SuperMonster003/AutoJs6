...
In the table, data in the `Active Maintenance` column that contains angle brackets (`<>`) is calculated up to Oct 27, 2025.
...
As of Oct 27, 2025, AutoJs6 supports up to version `24` of the JDK.
