// @Reference to aiselp (https://github.com/aiselp) on Jul 6, 2023.
//  ! https://github.com/aiselp/AutoX/commit/7176f5ad52d6904383024fb700bf19af75e22903
...
_typeof(prop)==='object'&&!Array.isArray(prop)){return(0,utils_js_1.domEach)(this,function(el,i){if((0,utils_js_1.isTag)(el)){// `prop` cannot be an array here anymore.
...
return exports.filters["root"](next,rule,options);}if(context.length===1){// NOTE: cannot be unpacked, as :has uses this for side-effects
...
this.emitOpenTag("p");this.closeCurrentTag(true);}}else if(!this.options.xmlMode&&name==="br"){// We cannot use `emitOpenTag` for implicit open, as `br` would be implicitly closed.
...
this._addGap();return(0,unicode_js_1.getSurrogatePairCodePoint)(cp,nextCp);}}//NOTE: we are at the end of a chunk, therefore we cannot infer the surrogate pair yet.
...
/******/ // This entry module is referenced by other modules so it cannot be inlined
