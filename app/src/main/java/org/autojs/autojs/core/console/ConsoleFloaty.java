...
public class ConsoleFloaty extends ResizableExpandableFloaty.AbstractResizableExpandableFloaty {
    ...
    private int mInitialWidth = (int) (ScreenMetrics.getDeviceScreenWidth() * 0.71);
    private int mInitialHeight = (int) (ScreenMetrics.getDeviceScreenHeight() * 0.42);

    private float mConsolePadding = 8.0f;
    ...
    private void setUpConsole(View view, ResizableExpandableFloatyWindow window) {
        ...
        int padding = (int) DisplayUtils.dpToPx(view.getContext(), mConsolePadding);
        consoleView.setPadding(padding, padding, padding, padding);
