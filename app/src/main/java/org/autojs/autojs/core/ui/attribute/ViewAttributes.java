...
import org.autojs.autojs.core.internal.Functions;
...
public class ViewAttributes {
    ...
    protected static class BaseAttribute implements Attribute {
    ...
    protected void onRegisterAttrs() {
        ...
        registerAttr("backgroundTintMode", BaseViewInflater.TINT_MODES::get,
        ...
        registerAttr("visibility", BaseViewInflater.VISIBILITY::get, mView::setVisibility);
        ...
        registerAttr("scrollbarStyle", BaseViewInflater.SCROLLBARS_STYLES::get, mView::setScrollBarStyle);
        ...
        registerAttr("scrollIndicators", BaseViewInflater.SCROLL_INDICATORS::get, bind(ViewCompat::setScrollIndicators, mView));
        ...
        registerAttr("textAlignment", BaseViewInflater.TEXT_ALIGNMENTS::get, mView::setTextAlignment);
        registerAttr("textDirection", BaseViewInflater.TEXT_DIRECTIONS::get, mView::setTextDirection);
        ...
        registerAttr("drawingCacheQuality", BaseViewInflater.DRAWABLE_CACHE_QUALITIES::get, mView::setDrawingCacheQuality);
        ...
        registerAttr("foregroundTintMode", BaseViewInflater.TINT_MODES::get, this::setForegroundTintMode);
        registerAttr("importantForAccessibility", BaseViewInflater.IMPORTANT_FOR_ACCESSIBILITY::get, mView::setImportantForAccessibility);
        registerAttr("layoutDirection", BaseViewInflater.LAYOUT_DIRECTIONS::get, mView::setLayoutDirection);
    }
    ...
    protected int parseDimension(String dim) {
        return switch (dim) {
            ...
            case "fill_parent", "match_parent" -> ViewGroup.LayoutParams.MATCH_PARENT;
            default -> Dimensions.parseToPixel(dim, mView, (ViewGroup) mView.getParent(), true);
        };
    }
    ...
    protected void registerAttrs(String[] names, AttributeSetter setter) {
        registerAttrs(names, new BaseAttribute(setter));
    }

    protected void registerAttrs(String[] names, Attribute attribute) {
    ...
    protected void setMargin(String  margin) {
        if (mView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams params) {
