 ...
 */
class JsEditTextViewInflater(resourceParser: ResourceParser) : EditTextInflater<JsEditText>(resourceParser) {
    ...
    override fun getCreator(): ViewCreator<in JsEditText> = ViewCreator { context, _ -> JsEditText(context) }
