...
public class Floaty {
    ...
    public Floaty(UiHandler uiHandler, ScriptRuntime runtime) {
        ...
        mDisplayOverOtherAppsPerm = new DisplayOverOtherAppsPermission(mContext);
    }
    ...
    public class JsRawWindow implements JsWindow {
        ...
        public void setSize(int w, int h) {
            runWithWindow(() -> {
                        ...
                        ViewUtils.setViewMeasure(mWindow.getWindowView(), w, h);
                    }
            );
        }
    ...
    public class JsResizableWindow implements JsWindow {
        ...
        public void setSize(int w, int h) {
            runWithWindow(() -> {
                        mWindow.getWindowBridge().updateMeasure(w, h);
                        ViewUtils.setViewMeasure(mWindow.getRootView(), w, h);
                    }
            );
        }
