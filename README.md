...
表格中 `活跃维护期` 列包含尖括号 (`<>`) 的数据, 其统计截止日期为 2025 年 10 月 27 日.
...
* [Rhino](https://github.com/mozilla/rhino/) 引擎由 [v1.7.7.2](https://github.com/mozilla/rhino/releases/tag/Rhino1_7_7_2_Release) 升级至 [v1.8.1-SNAPSHOT](http://rhino.autojs6.com/blob/master/gradle.properties#L3) (更新于 2025 年 10 月 5 日)
...
下载 `Android Studio Narwhal 4 Feature Drop | 2025.1.4` 版本 (按需选择其一):
...
> 注: 上述版本发布时间为 2025 年 10 月 9 日. 如需下载其他版本, 或上述链接已失效, 可访问 [Android Studio 发行版本归档](https://developer.android.com/studio/archive?hl=en) 页面.
...
截至 2025 年 10 月 27 日, AutoJs6 可支持 JDK 最高版本为 `24`.
